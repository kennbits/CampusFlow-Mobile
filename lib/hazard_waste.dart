...
class HazardWastePage extends StatefulWidget {
  const HazardWastePage({Key? key}) : super(key: key);

  @override
  State<HazardWastePage> createState() => _HazardWastePageState();
}

class _HazardWastePageState extends State<HazardWastePage> {
  ...
  void _submit() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('Hazard Waste submitted: $waste kg')),
    );
  }

  @override
  Widget build(BuildContext context) {
    return _buildForm('Hazard Waste');
  }
