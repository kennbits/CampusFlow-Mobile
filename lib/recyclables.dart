...
class RecyclablesPage extends StatefulWidget {
  ...
  @override
  State<RecyclablesPage> createState() => _RecyclablesPageState();
}

class _RecyclablesPageState extends State<RecyclablesPage> {
  ...
  void _submit() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('Recyclables submitted: $waste kg')),
    );
  }

  @override
  Widget build(BuildContext context) {
    return _buildForm('Recyclables');
  }
