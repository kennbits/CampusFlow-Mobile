...
class AlbertEinsteinPage extends StatefulWidget {
  const AlbertEinsteinPage({Key? key}) : super(key: key);

  @override
  State<AlbertEinsteinPage> createState() => _AlbertEinsteinPageState();
}

class _AlbertEinsteinPageState extends State<AlbertEinsteinPage> {
  ...
  void _submit() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('ALBERT EINSTEIN submitted: $reading kWh')),
    );
  }

  @override
  Widget build(BuildContext context) {
    return _buildForm('ALBERT EINSTEIN');
  }
