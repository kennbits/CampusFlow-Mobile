...
class RgrPage extends StatefulWidget {
  const RgrPage({Key? key}) : super(key: key);

  @override
  State<RgrPage> createState() => _RgrPageState();
}

class _RgrPageState extends State<RgrPage> {
  ...
  void _submit() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('RGR submitted: $reading kWh')),
    );
  }

  @override
  Widget build(BuildContext context) {
    return _buildForm('RGR');
  }
