...
class FdcPage extends StatefulWidget {
  const FdcPage({Key? key}) : super(key: key);

  @override
  State<FdcPage> createState() => _FdcPageState();
}

class _FdcPageState extends State<FdcPage> {
  ...
  void _submit() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('FDC submitted: $reading kWh')),
    );
  }

  @override
  Widget build(BuildContext context) {
    return _buildForm('FDC');
  }
