...
class SteerhubPage extends StatefulWidget {
  const SteerhubPage({Key? key}) : super(key: key);

  @override
  State<SteerhubPage> createState() => _SteerhubPageState();
}

class _SteerhubPageState extends State<SteerhubPage> {
  ...
  void _submit() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('STEERHUB submitted: $reading kWh')),
    );
  }

  @override
  Widget build(BuildContext context) {
    return _buildForm('STEERHUB');
  }
